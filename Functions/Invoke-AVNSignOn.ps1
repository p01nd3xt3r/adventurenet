...
Function Invoke-AVNSignOn {
    ...
    If ($AVNLastSignOnInterval -gt (New-TimeSpan -Hours 24)) {
        ...
        write-host "`n`n                            ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿           `n                            ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿           `n                         ⣿⣿⣿                                                  ⣿⣿           `n                      ⣿⣿⣿                                                     ⣿⣿           `n                      ⣿                                                    ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿                                                     ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿                                                     ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿█⣿⣿██⣿⣿█⣿█⣿███⣿█⣿█⣿███⣿█⣿█⣿███⣿███⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿█⣿█⣿█⣿█⣿█⣿█⣿█⣿⣿⣿███⣿⣿█⣿⣿█⣿█⣿█⣿█⣿█⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿███⣿█⣿█⣿█⣿█⣿██⣿⣿███⣿⣿█⣿⣿█⣿█⣿██⣿⣿██⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿█⣿█⣿██⣿⣿██⣿⣿███⣿█⣿█⣿⣿█⣿⣿███⣿█⣿█⣿███⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿█⣿█⣿███⣿███⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿███⣿█⣿⣿⣿⣿█⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿███⣿██⣿⣿⣿█⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿█⣿█⣿███⣿⣿█⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿       ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿                                                     ⣿⣿⣿⣿⣿           `n                   ⣿⣿⣿                                                     ⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿  `n                   ⣿⣿⣿                                                     ⣿⣿⣿⣿⣿   ⣿⣿⣿  ⣿  `n                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿  ⣿⣿⣿⣿⣿   ⣿  `n                    ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿     ⣿  `n                                                                             ⣿⣿⣿ ⣿⣿   ⣿⣿⣿  `n             ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿  `n           ⣿⣿⣿                                                                     ⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿                                                                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿                                                                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿                                  ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿       ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿          ⣿⣿⣿                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿      ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿         ⣿⣿⣿⣿⣿⣿                 ⣿████████████████████████████⣿     ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿         ⣿⣿⣿⣿⣿⣿                                   ⣿⣿               ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿                                                                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿                                                                   ⣿⣿⣿⣿⣿⣿⣿⣿⣿  `n          ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿██    ⣿⣿⣿██   ⣿⣿⣿██⣿   ⣿⣿⣿██    ⣿⣿███   ⣿⣿⣿██⣿   ⣿⣿⣿██   ⣿██⣿⣿⣿⣿⣿⣿     `n        ⣿⣿⣿   ⣿⣿⣿⣿⣿⣿     ⣿⣿⣿⣿     ⣿⣿⣿     ⣿⣿⣿⣿     ⣿⣿⣿      ⣿⣿⣿     ⣿⣿⣿⣿     ⣿⣿⣿⣿⣿⣿⣿⣿      `n     ⣿⣿⣿      ⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿⣿   ⣿⣿⣿⣿⣿    ⣿⣿⣿⣿⣿           `n     ⣿⣿⣿   ⣿⣿⣿██⣿⣿⣿⣿⣿⣿⣿██⣿⣿⣿⣿⣿⣿███⣿⣿⣿⣿⣿⣿██⣿⣿⣿⣿⣿⣿⣿██⣿⣿⣿⣿⣿⣿███⣿⣿⣿⣿⣿⣿██⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿           `n  ⣿⣿⣿                                                                      ⣿⣿⣿             `n  ⣿⣿⣿                                                                     ⣿⣿⣿              `n  ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿                `n`n" -ForegroundColor $global:AVNDefaultBannerForegroundColor
        Wait-AVNKeyPress
